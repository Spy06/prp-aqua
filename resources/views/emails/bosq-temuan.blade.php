...
<head>
    ...
    <style>
        ...
        .email-header { background: linear-gradient(135deg, #0d9488 0%, #14b8a6 100%); padding: 24px; text-align: center; color: #ffffff; }
        ...
        .btn-action { display: inline-block; background-color: #0d9488; color: #ffffff !important; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: 600; font-size: 14px; margin-top: 20px; text-align: center; }
    ...
    <div class="email-card">
        ...
        <div class="email-body">
                ...
                <tr>
                    ...
                    <td class="value">
                        @if($temuan->dampak_temuan === 'positif')
                            <span style="color: #2e7d32; font-weight: 700;">👍 Positif (Perilaku Baik)</span>
                        @else
                            <span style="color: #c62828; font-weight: 700;">👎 Negatif (Butuh Perbaikan)</span>
                        @endif
                    </td>
                </tr>
                <tr>
            ...
            <div style="text-align: center;">
                <a href="{{ route('bosq.temuan.detail', $temuan->id) }}" class="btn-action">Lihat Detail Observasi BOS'Q</a>
            </div>
        </div>
