...
<head>
    ...
    <style>
        ...
        * {
        ...
        .fu {
            animation: fadeUp 0.4s cubic-bezier(0.25, 0.8, 0.25, 1) both;
        }

        .fu1 {
            animation: fadeUp 0.45s 0.05s cubic-bezier(0.25, 0.8, 0.25, 1) both;
        }

        .fu2 {
            animation: fadeUp 0.45s 0.1s cubic-bezier(0.25, 0.8, 0.25, 1) both;
        }

        .fu3 {
            animation: fadeUp 0.45s 0.15s cubic-bezier(0.25, 0.8, 0.25, 1) both;
        }
...
<body>
            ...
            @auth
                <div class="qs-user">
                    ...
                    <div style="overflow:hidden;flex:1;min-width:0;">
                        <div
                            style="color:var(--btxt);font-size:13px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                            {{ auth()->user()->name }}</div>
                        <div
                            style="color:var(--btxt2);font-size:11px;text-transform:capitalize;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                            {{ auth()->user()->role }}</div>
                    </div>
                </div>
                <a href="{{ route('profile.edit') }}" class="qs-logout"
    ...
    <dialog id="custom-confirm-modal"
        ...
        <div style="display:flex;align-items:flex-start;gap:14px;margin-bottom:20px;">
            <div
                style="width:40px;height:40px;border-radius:10px;background:#e3f2fd;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
