    ...
    <style>
        ...
        * {
        ...
        .bbtn-secondary {
            background: var(--bsur);
            color: var(--btxt);
            border: 1px solid var(--bbor) !important;
        }
        ...
        .fu1 {
            animation: fadeUp 0.4s 0.05s cubic-bezier(0.25, 0.8, 0.25, 1) both;
        }

        .fu2 {
            animation: fadeUp 0.4s 0.1s cubic-bezier(0.25, 0.8, 0.25, 1) both;
        }

        .fu3 {
            animation: fadeUp 0.4s 0.15s cubic-bezier(0.25, 0.8, 0.25, 1) both;
        }
    ...
    <header class="qtop">
        <div style="display:flex; align-items:center; gap:10px;">
            ...
            <div class="logo-area qtop-logo">
                <div class="logo-box"
                    style="background: linear-gradient(135deg, #7c3aed, #9333ea); border-radius: 12px; box-shadow: 0 4px 14px rgba(124, 58, 237, 0.3); flex-shrink: 0;">
                    <span class="material-symbols-outlined" style="color:#fff;">verified_user</span>
                </div>
                <div class="logo-text">
                    <h1
                        style="color:#7c3aed; font-size: {{ auth()->user()->isSuperAdmin() ? '14px' : '17px' }}; font-weight: 800; letter-spacing: -0.2px; margin: 0; white-space: nowrap;">
                        {{ auth()->user()->isSuperAdmin() ? "Admin Sivera & BosQ" : "SIVERA" }}</h1>
                </div>
            </div>
        </div>
