<div style="display:flex;flex-direction:column;gap:24px;" class="fu">
    ...
    <div class="bph fu1">
        <div>
            ...
            <p class="bph-sub">Ringkasan kepatuhan per departemen & detail pencapaian per anggota (Week 1 s/d Week 4)</p>
        </div>
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;">
            <a href="{{ route('bosq.qa.export.rekap.csv', ['date' => $bulan_tahun . '-01']) }}" class="bbtn bbtn-secondary bbtn-sm">
                <span class="material-symbols-outlined" style="font-size:18px;color:#2e7d32;">csv</span>
                Export Excel / CSV
            </a>
            <a href="{{ route('bosq.qa.export.rekap.pdf', ['date' => $bulan_tahun . '-01']) }}" target="_blank" class="bbtn bbtn-primary bbtn-sm">
    ...
    <div class="bcard fu1" style="padding:18px 20px;background:#ffffff;border:1px solid #e2e8f0;border-radius:12px;">
        <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px;flex-wrap:wrap;">
            <div style="display:flex;align-items:center;gap:8px;">
                ...
                <span style="font-size:14px;font-weight:700;color:var(--btxt);">Kustomisasi Periode & Rentang Tanggal Week 1 - Week 4:</span>
            </div>

            <div style="display:flex;align-items:center;gap:10px;">
                <label style="font-size:13px;font-weight:600;color:var(--btxt2);">Pilih Bulan:</label>
                <input type="month" wire:model.live="bulan_tahun" class="binput" style="width:auto;padding:6px 12px;font-weight:700;" />
                <button wire:click="generateDefaultWeeks" class="bbtn bbtn-secondary bbtn-sm" title="Reset Rentang Tanggal Default">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(220px, 1fr));gap:12px;padding:12px;background:#f8fafc;border-radius:10px;border:1px solid #e2e8f0;">
            {{-- Week 1 --}}
            <div style="display:flex;flex-direction:column;gap:4px;">
                <span style="font-size:11.5px;font-weight:700;color:#1e293b;display:flex;align-items:center;gap:4px;">
                    <span class="material-symbols-outlined" style="font-size:14px;color:var(--bp);">calendar_today</span>
                    WEEK 1 (Tgl: {{ $weeks['w1']['label'] }})
                </span>
                <div style="display:flex;align-items:center;gap:4px;">
                    <input type="date" wire:model.live="week1_start" class="binput" style="padding:4px 8px;font-size:12px;" />
                    <span style="font-size:11px;color:#64748b;">s/d</span>
                    <input type="date" wire:model.live="week1_end" class="binput" style="padding:4px 8px;font-size:12px;" />
                </div>
            </div>
            ...
            <div style="display:flex;flex-direction:column;gap:4px;">
                ...
                <div style="display:flex;align-items:center;gap:4px;">
                    <input type="date" wire:model.live="week2_start" class="binput" style="padding:4px 8px;font-size:12px;" />
                    <span style="font-size:11px;color:#64748b;">s/d</span>
                    <input type="date" wire:model.live="week2_end" class="binput" style="padding:4px 8px;font-size:12px;" />
                </div>
            </div>
            ...
            <div style="display:flex;flex-direction:column;gap:4px;">
                ...
                <div style="display:flex;align-items:center;gap:4px;">
                    <input type="date" wire:model.live="week3_start" class="binput" style="padding:4px 8px;font-size:12px;" />
                    <span style="font-size:11px;color:#64748b;">s/d</span>
                    <input type="date" wire:model.live="week3_end" class="binput" style="padding:4px 8px;font-size:12px;" />
                </div>
            </div>
            ...
            <div style="display:flex;flex-direction:column;gap:4px;">
                ...
                <div style="display:flex;align-items:center;gap:4px;">
                    <input type="date" wire:model.live="week4_start" class="binput" style="padding:4px 8px;font-size:12px;" />
                    <span style="font-size:11px;color:#64748b;">s/d</span>
                    <input type="date" wire:model.live="week4_end" class="binput" style="padding:4px 8px;font-size:12px;" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bcard fu2" style="overflow:hidden;border:1px solid #cbd5e1;border-radius:12px;box-shadow:0 4px 16px rgba(0,0,0,0.06);">
        <div style="padding:14px 18px;background:#1e293b;color:#ffffff;display:flex;align-items:center;justify-content:space-between;">
            <div style="display:flex;align-items:center;gap:8px;">
                <span class="material-symbols-outlined" style="color:#38bdf8;font-size:22px;">table_chart</span>
                <div>
                    <h3 style="font-size:15px;font-weight:800;margin:0;letter-spacing:0.5px;">REKAP KEPATUHAN PER DEPARTEMEN</h3>
                    <p style="font-size:11.5px;color:#94a3b8;margin:0;">Ringkasan pencapaian persentase target observasi per departemen</p>
                </div>
            </div>
            <span style="font-size:12px;font-weight:700;padding:4px 10px;background:#334155;border-radius:20px;color:#38bdf8;">
                Periode: {{ $monthName }}
            </span>
        </div>

        <div style="overflow-x:auto;">
            <table style="width:100%;border-collapse:collapse;font-family:'Inter',sans-serif;font-size:13px;border:1px solid #94a3b8;">
                <thead>
                    <tr style="background:#0f172a;color:#ffffff;text-align:center;font-weight:800;font-size:12.5px;letter-spacing:0.8px;">
                        <th style="padding:10px 16px;text-align:left;border:1px solid #334155;width:300px;background:#1e293b;">
                            {{ $monthShort }}
                        </th>
                ...
                <tbody>
                    @foreach($deptSummary as $ds)
                        <tr style="border-bottom:1px solid #cbd5e1;background:#ffffff;">
                            <td style="padding:8px 16px;border:1px solid #cbd5e1;font-weight:800;color:#0f172a;letter-spacing:0.5px;">
                                {{ $ds['nama'] }}
                            </td>

                            {{-- Week 1 --}}
                            @php $p1 = $ds['scores']['w1']['persen']; @endphp
                            <td style="padding:8px;text-align:center;border:1px solid #cbd5e1;font-weight:800;font-size:13px;
    ...
    <div class="bcard fu2" style="overflow:hidden;border:1px solid #cbd5e1;border-radius:12px;box-shadow:0 4px 16px rgba(0,0,0,0.06);">
        <div style="padding:14px 18px;background:#0f172a;color:#ffffff;display:flex;align-items:center;justify-content:space-between;">
            <div style="display:flex;align-items:center;gap:8px;">
                ...
                <div>
                    <h3 style="font-size:15px;font-weight:800;margin:0;letter-spacing:0.5px;">DETAIL PENCAPAIAN BQA PER ANGGOTA DEPARTEMEN</h3>
                    <p style="font-size:11.5px;color:#94a3b8;margin:0;">Detail pencapaian individu anggota divisi manajemen di tiap minggu</p>
                </div>
            </div>
        </div>

        <div style="overflow-x:auto;">
            <table style="width:100%;border-collapse:collapse;font-family:'Inter',sans-serif;font-size:12.5px;border:1px solid #94a3b8;">
                <thead>
                    {{-- Header Baris 1: Judul Pencapaian & Nama Bulan --}}
                    <tr style="background:#0f172a;color:#ffffff;text-align:center;">
                        <th style="padding:10px 16px;text-align:left;border:1px solid #334155;width:320px;font-weight:800;font-size:13px;letter-spacing:0.5px;">
                            PENCAPAIAN BQA
                            <div style="font-size:11px;font-weight:400;color:#94a3b8;margin-top:2px;">Sum of % in WEEK</div>
                        </th>
                        <th colspan="4" style="padding:10px;border:1px solid #334155;font-weight:800;font-size:14px;letter-spacing:1px;background:#1e293b;color:#38bdf8;">
                            {{ $monthName }}
                        </th>
                    </tr>
                    ...
                    <tr style="background:#475569;color:#ffffff;text-align:center;font-size:11.5px;font-weight:800;letter-spacing:0.5px;">
                        <th style="padding:8px 16px;text-align:left;border:1px solid #64748b;background:#334155;color:#cbd5e1;">
                            Column Labels
                        </th>
                ...
                <tbody>
                    @foreach($matrixData as $deptGroup)
                        ...
                        <tr style="background:#94a3b8;color:#0f172a;font-weight:800;font-size:12px;letter-spacing:0.8px;">
                            <td colspan="5" style="padding:7px 16px;border:1px solid #64748b;background:#cbd5e1;color:#0f172a;text-transform:uppercase;">
                        ...
                        @forelse($deptGroup['members'] as $m)
                            <tr style="border-bottom:1px solid #cbd5e1;background:#ffffff;">
                                ...
                                <td style="padding:7px;text-align:center;border:1px solid #cbd5e1;font-weight:700;
                        ...
                        @empty
                            <tr style="background:#ffffff;">
                                <td colspan="5" style="padding:10px 16px;text-align:center;color:#94a3b8;font-style:italic;border:1px solid #cbd5e1;">
    ...
    <div class="bcard fu2" style="padding:16px 20px;background:#ffffff;border:1px solid #cbd5e1;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.04);">
        <div style="display:flex;align-items:center;gap:18px;flex-wrap:wrap;font-size:13px;font-weight:600;">
            ...
            {{-- 100% Tercapai --}}
            <div style="display:flex;align-items:center;gap:8px;padding:6px 14px;border-radius:20px;background:#dcfce7;color:#15803d;border:1px solid #86efac;">
            ...
            {{-- 50%-99% Sebagian --}}
            <div style="display:flex;align-items:center;gap:8px;padding:6px 14px;border-radius:20px;background:#fef08a;color:#854d0e;border:1px solid #fde047;">
            ...
            {{-- 0% Belum Mengirim --}}
            <div style="display:flex;align-items:center;gap:8px;padding:6px 14px;border-radius:20px;background:#f1f5f9;color:#64748b;border:1px solid #cbd5e1;">
