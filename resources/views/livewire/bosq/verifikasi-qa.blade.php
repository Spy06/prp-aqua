<div class="bcard" style="border-left:4px solid #f59e0b;margin-top:20px;">
    <div class="bcard-header">
        ...
        <div>
            <div style="font-size:15px;font-weight:700;color:var(--btxt);">Verifikasi QA — BOS'Q</div>
            <div style="font-size:12px;color:var(--btxt2);">Tinjau tindak lanjut Auditee dan berikan keputusan</div>
        </div>
    </div>
