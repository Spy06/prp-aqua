<div>
    ...
    <div class="bph fu1">
        <div>
            <h2 class="bph-title">Daftar Temuan Saya</h2>
            <p class="bph-sub">Laporan temuan yang pernah Anda ajukan</p>
        </div>
    </div>
    ...
    @if($temuans->isEmpty())
        <div class="bcard fu2" style="padding:52px;text-align:center;">
            ...
            <div style="font-size:15px;font-weight:600;color:var(--btxt);margin-bottom:6px;">Belum ada temuan</div>
            <p style="font-size:13px;color:var(--btxt2);">Belum ada temuan yang Anda laporkan.</p>
        </div>
    @else
        <div class="tcard-grid fu2">
            @foreach($temuans as $temuan)
                ...
                <a href="{{ route('temuan.detail', $temuan->id) }}" class="tcard">
                    ...
                    <div class="tcard-footer">
                        ...
                        <div style="display:flex;align-items:center;gap:5px;">
                            ...
                            <span class="truncate" style="max-width:110px;">{{ $temuan->pic->name ?? 'Belum ada PIC' }}</span>
                        </div>
                    </div>
                </a>
            @endforeach
