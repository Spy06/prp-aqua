<div class="space-y-5" id="master-akun-user-container">
    ...
    @if($showFormCreate)
        <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-5">
            ...
            {{-- Aturan penting --}}
            <div class="flex items-start gap-2 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 text-amber-700 dark:text-amber-300 text-xs mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    {{-- Status NIK lookup --}}
                    @if($nikSearchResult)
                        <div class="flex items-center gap-2 mt-2 p-2 rounded-lg bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 text-xs">
                    ...
                    @elseif($nikSearchError)
                        <div class="flex items-center gap-2 mt-2 p-2 rounded-lg bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300 text-xs">
                ...
                {{-- Role --}}
                <div>
                    <label for="form-role" class="block text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-1">Role <span class="text-red-500">*</span></label>
                ...
                {{-- No. WhatsApp --}}
                <div>
                    <label for="form-wa" class="block text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-1">No. WhatsApp <span class="text-red-500">*</span></label>
            ...
            <div class="flex justify-end gap-3 mt-5">
                <button wire:click="$set('showFormCreate', false)" class="px-4 py-2 text-sm text-zinc-600 dark:text-zinc-400 transition">Batal</button>
                <button wire:click="buatAkun" wire:loading.attr="disabled" id="btn-submit-akun"
                    ...
                    <span wire:loading.remove wire:target="buatAkun"><flux:icon.check variant="outline" class="w-4 h-4" /></span>
    ...
    @if($showFormEdit)
        <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label for="edit-role" class="block text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-1">Role</label>
                ...
                <div>
                    <label for="edit-wa" class="block text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-1">No. WhatsApp</label>
            ...
            <div class="flex justify-end gap-3 mt-4">
                <button wire:click="$set('showFormEdit', false)" class="px-4 py-2 text-sm text-zinc-600 dark:text-zinc-400 transition">Batal</button>
