        ...
        <div class="flex items-center gap-2 flex-wrap justify-center">
            ...
            @else
                <button type="button" wire:click="previousPage"
                   class="inline-flex items-center justify-center w-8 h-8 rounded-lg text-zinc-500 dark:text-zinc-400 hover:bg-primary-container hover:text-on-primary-container dark:hover:bg-surface-container-high transition-colors cursor-pointer"
                    ...
                    @foreach ($element as $page => $url)
                        ...
                        @else
                            <button type="button" wire:click="gotoPage({{ $page }})"
                               class="inline-flex items-center justify-center w-8 h-8 rounded-lg text-xs font-medium text-zinc-600 dark:text-zinc-400 hover:bg-primary-container hover:text-on-primary-container dark:hover:bg-surface-container-high transition-colors cursor-pointer"
